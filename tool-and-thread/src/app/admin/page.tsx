          ...
          <CardContent className="space-y-2">
            {Object.entries(currencyTotals).map(([currency, total]) => (
              <p key={currency} className="text-2xl font-bold text-slate-700">
                ...
                {total.toFixed(2)}
                <span className="text-sm ml-1 font-medium text-slate-500">
                  {currency}
                </span>
              </p>
            ))}
        ...
        <Card className="border-slate-200 shadow-sm hover:shadow-md transition-shadow">
          ...
          <CardContent className="space-y-3">
            ...
            <Link href="/admin/transactions">
              <Button
                variant="outline"
                className="w-full flex items-center justify-center gap-2 border-slate-300 text-slate-700 font-medium hover:bg-slate-50 transition-colors"
              >
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <Link href="/admin/transactions">
            <Button
              variant="ghost"
              size="sm"
              className="text-primary-500 hover:text-primary-600 hover:bg-primary-50 font-medium transition-colors"
            >
              View All
            </Button>
          </Link>
                ...
                return (
                  <tr key={transaction.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-500 text-right">
                      ...
                      {total.toFixed(2)} {transaction.currency}
                    </td>
